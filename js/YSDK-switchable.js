...
YSDK.add(function () {
    ...
    function Switchable(container, config) {
        ...
        config = $.merge(Switchable.Config, config);
...
YSDK.add(function () {
     ...
     * 覆盖切换方法
     */
    Switchable.prototype.switchView = function (fromEls, toEls, index, direction) {
        var self = this, cfg = self.config,
            effect = cfg.effect,
...
YSDK.add(function () {
    ...
    function circularScroll(fromEls, toEls, callback, index, direction) {
        ...
        self.anim = $(self.content)(props, {duration: cfg.duration, easing: cfg.easing}, function () {
            if (isCritical) {
                // 复原位置
